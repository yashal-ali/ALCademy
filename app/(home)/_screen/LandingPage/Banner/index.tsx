...
<div
    ...
    >
      <div className="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center text-center text-white">
        <h1 className="xl:text-[60px] md:text-[40px] text-[30px] sm:text-[32px] text-white font-extrabold ">
        Our Mission
        </h1>
        <p className="xl-text-2xl lg:text-xl md:text-lg sm:text-sm text-white mt-3 mb-4 pb-4 max-w-[75%]">
